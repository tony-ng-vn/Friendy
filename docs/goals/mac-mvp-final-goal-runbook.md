# Mac-Only MVP Final Goal Runbook

Use these prompts one at a time. Each goal executes exactly one task from `docs/superpowers/plans/2026-05-22-mac-only-mvp-final-implementation.md`.

1. Node version and CI:
