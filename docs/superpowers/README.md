...
- [Identity resolution design — concrete fix stack PR 6](specs/2026-05-23-identity-resolution-design.md)
- [Robust delete/update design — concrete fix stack PR 7](specs/2026-05-23-robust-delete-update-design.md)
- [Sensor normalization and ack lifecycle design — concrete fix stack PR 8](specs/2026-05-23-sensor-normalization-ack-lifecycle-design.md)
- [Strict-mode dogfooding trace design — concrete fix stack PR 9](specs/2026-05-23-strict-mode-dogfooding-trace-design.md)
...
- [Iteration 2 relationship agent core implementation plan](plans/2026-05-20-relationship-agent-core.md)

Note: the plan originally targeted a `Friendy` directory. The implementation was later adapted to live at the Friendy repo root because this repository only contained a README when work started.
